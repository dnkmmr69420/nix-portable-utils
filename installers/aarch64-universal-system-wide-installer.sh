...
sudo wget -P /usr/local/bin https://github.com/DavHau/nix-portable/releases/download/v009/nix-portable-aarch64-linux
sudo mv /usr/local/bin/nix-portable-aarch64-linux /usr/local/bin/nix-portable
