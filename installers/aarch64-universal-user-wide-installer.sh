...
wget -P ~/.local/bin https://github.com/DavHau/nix-portable/releases/download/v009/nix-portable-aarch64-linux
mv ~/.local/bin/nix-portable-aarch64-linux ~/.local/bin/nix-portable
