...
sudo wget -P /usr/local/bin https://raw.githubusercontent.com/dnkmmr69420/nix-portable-utils/main/nix-exec-and-ls/nix-abexec
sudo chmod a+x /usr/local/bin/nix-exec
sudo chmod a+x /usr/local/bin/nix-ls
sudo chmod a+x /usr/local/bin/nix-abexec
